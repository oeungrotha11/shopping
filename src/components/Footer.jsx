...
function Footer() {
  return (
    <div>
      ...
      <div class="bg-gray-100 py-16 px-6 flex justify-center">
        <div class="max-w-screen-xl mx-auto">
            ...
            <div class="lg:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <ul class="space-y-2">
                  ...
                  <li><i class="fa-brands fa-facebook-messenger"></i>Messenger</li>
          ...
          <div class='grid lg:grid-cols-4 md:grid-cols-2 gap-6'>
            ...
            <div class='flex items-center gap-6'>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0 fill-purple-600 stroke-purple-600" viewBox="0 0 682.667 682.667">
                ...
                <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="40" clip-path="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)">
            ...
            <div class='flex items-center gap-6'>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0 fill-purple-600 stroke-purple-600" viewBox="0 0 682.667 682.667">
                ...
                <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="30" clip-path="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)">
                  <path d="M169.928 155.283v-46.989S166.169 15.006 256 15.006s86.073 93.288 86.073 93.288v46.989" data-original="#000000" />
                  <path d="m342.072 108.294 136.671-58.149a30 30 0 0 0 18.255-27.598l.002-7.545H15l.001 7.544a30.001 30.001 0 0 0 18.255 27.6l136.671 58.148M256 118.17c-65.059 0-112.046 47.906-112.046 107v123.179C167 458.669 223.888 398.002 256 398.002c32.112 0 86.072 60.667 112.046-49.653V225.17c0-59.094-46.987-107-112.046-107ZM143.954 223.839h-40c-16.568 0-30 13.431-30 30v64.51c0 16.568 13.432 30 30 30h40ZM408.046 223.839h-40v124.51h40c16.569 0 30-13.432 30-30v-64.51c0-16.569-13.431-30-30-30Z" data-original="#000000" />
                  <path d="m368.046 223.839-35.211-23.48a70.007 70.007 0 0 0-38.836-11.761H268.63M399.461 348.349v5.189c0 79.231-33.461 143.461-143.461 143.461-110 0-143.461-64.23-143.461-143.461v-5.189" data-original="#000000" />
                </g>
              </svg>
              <div>
          ...
          <div class="flex items-center justify-between flex-wrap gap-6">
            <p class="text-slate-900 text-sm">© ReadymadeUI. All rights reserved.</p>
