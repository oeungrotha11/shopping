    ...
    <div>
    {
      ...
      <div class="lg:max-w-6xl max-w-xl mx-auto">
        <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
          ...
          <div class="w-full">
            <div>
              <h3 class="text-lg sm:text-xl font-semibold text-slate-900">{}</h3>
              <p class="text-slate-500 mt-2 text-sm">{pro.title}
              </p>
              <div class="flex items-center flex-wrap gap-4 mt-6">
                <h4 class="text-slate-900 text-2xl sm:text-3xl font-semibold">{pro.price}</h4>
                <p class="text-slate-500 text-lg"><strike>$16</strike> <span class="text-sm ml-1.5">{pro.oldPrice}</span></p>
              </div>
